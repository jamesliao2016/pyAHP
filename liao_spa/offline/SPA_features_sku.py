...
app_name = 'spa_p101_sku_feature_0608'
...
WHERE
    dt >= '%s'
AND dt <= '%s'
and item_sku_id in (758350,766923,889167,976141,1084804)
...
WHERE
    dt >= '%s'
AND dt <= '%s'
and sku_id in (758350,766923,889167,976141,1084804)
...
logger.info('inserting app.app_p101_features_dtsku_0608_3...')
spa_utils.save_result(df_complete,
                      'app.app_p101_features_dtsku_0608_3',
                      partitioning_columns=['dt'],
                      write_mode=params['write_mode'],
                      spark=spark, params = params)
# result_df.write.insertInto('app.app_p101_features_dtsku_0608',overwrite=True)
